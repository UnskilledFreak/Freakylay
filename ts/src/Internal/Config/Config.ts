...
namespace Freakylay.Internal.Config {
    ...
    export class Config implements IConfigable {
        ...
        constructor() {
            ...
            this.language = new EventProperty<string>(Freakylay.Ui.LanguageManager.GetDefaultLanguage());
        ...
        private useOldConfigAsDefault(): void {
            ...
            this.language.Value = this.getConfig('language', Freakylay.Ui.LanguageManager.GetDefaultLanguage());
        }
        ...
        load(data: {}) {
            ...
            this.language.Value = data.isset('l', Freakylay.Ui.LanguageManager.GetDefaultLanguage());
        }
